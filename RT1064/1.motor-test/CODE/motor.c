...
int Position_PID(int Encoder,int Target){ 	
	int Bias=0,Pwm=0,Integral_bias=0,Last_Bias=0;
	Bias=Target - Encoder;                                  
	Integral_bias+=Bias;	                                 
	Pwm=Position_KP*Bias+Position_KI*Integral_bias+Position_KD*(Bias-Last_Bias)+2000; 
	Last_Bias=Bias;                                       
	return Pwm;                                           
}
...
void PID_Calculate(void){
	duty1 = Position_PID(encoder1,speed_tar_1);
	duty2 = Position_PID(encoder2,speed_tar_2);
	duty3 = Position_PID(encoder3,speed_tar_3);
	duty4 = Position_PID(encoder4,speed_tar_4);
